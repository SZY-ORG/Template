 ...
 */
public class FrozenMoneyAdapter extends BaseAdapter<FrozenMoney, FrozenMoneyAdapter.FrozenMoneyViewHolder> {
	...
	@NonNull
	@Override
	public FrozenMoneyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_business, parent, false);
		return new FrozenMoneyViewHolder(this, view);
	}

	class FrozenMoneyViewHolder extends BaseViewHolder<FrozenMoney> {

		public FrozenMoneyViewHolder(BaseAdapter adapter, View itemView) {
			super(adapter, itemView);
		}

		@Override
		public void bindData(FrozenMoney data) {
